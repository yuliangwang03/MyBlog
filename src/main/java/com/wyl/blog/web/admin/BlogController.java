...
public class BlogController {
    private static final String INPUT = "admin/BlogPostPage";
    private static final String LIST = "admin/BlogManagePage";
    private static final String REDIRECT = "redirect:/admin/BlogManagePage";
    private static final String BLOG_LIST = "admin/BlogManagePage :: blogList";
    ...
    @PostMapping("/BlogManagePage/search")
    ...
    @GetMapping("/BlogManagePage/input")
    ...
    @Transactional
    @GetMapping("/BlogManagePage/{id}/edit")
    ...
    @GetMapping("/BlogManagePage/{id}/delete")
